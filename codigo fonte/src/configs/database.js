...
db.serialize(() => {
    ...
    db.run("INSERT OR IGNORE INTO Clientes (id, nome, email, cpf) VALUES (1, 'João Silva', 'joao@example.com', '123.456.789-00')");
    db.run("INSERT OR IGNORE INTO Clientes (id, nome, email, cpf) VALUES (2, 'Maria Oliveira', 'maria@example.com', '987.654.321-00')");
    db.run("INSERT OR IGNORE INTO Clientes (id, nome, email, cpf) VALUES (3, 'Carlos Santos', 'carlos@example.com', '111.222.333-44')");
    db.run("INSERT OR IGNORE INTO Clientes (id, nome, email, cpf) VALUES (4, 'Ana Souza', 'ana@example.com', '555.666.777-88')");
    db.run("INSERT OR IGNORE INTO Clientes (id, nome, email, cpf) VALUES (5, 'Pedro Pereira', 'pedro@example.com', '999.888.777-66')");

    db.run("INSERT OR IGNORE INTO Produtos (id, nome, descricao, preco) VALUES (1, 'Produto A', 'Descrição do Produto A', 50.00)");
    db.run("INSERT OR IGNORE INTO Produtos (id, nome, descricao, preco) VALUES (2, 'Produto B', 'Descrição do Produto B', 30.00)");
    db.run("INSERT OR IGNORE INTO Produtos (id, nome, descricao, preco) VALUES (3, 'Produto C', 'Descrição do Produto C', 80.00)");
    db.run("INSERT OR IGNORE INTO Produtos (id, nome, descricao, preco) VALUES (4, 'Produto D', 'Descrição do Produto D', 25.00)");
    db.run("INSERT OR IGNORE INTO Produtos (id, nome, descricao, preco) VALUES (5, 'Produto E', 'Descrição do Produto E', 60.00)");
    db.run("INSERT OR IGNORE INTO Produtos (id, nome, descricao, preco) VALUES (6, 'Produto F', 'Descrição do Produto F', 45.00)");
    db.run("INSERT OR IGNORE INTO Produtos (id, nome, descricao, preco) VALUES (7, 'Produto G', 'Descrição do Produto G', 70.00)");
    db.run("INSERT OR IGNORE INTO Produtos (id, nome, descricao, preco) VALUES (8, 'Produto H', 'Descrição do Produto H', 90.00)");
    db.run("INSERT OR IGNORE INTO Produtos (id, nome, descricao, preco) VALUES (9, 'Produto I', 'Descrição do Produto I', 55.00)");
    db.run("INSERT OR IGNORE INTO Produtos (id, nome, descricao, preco) VALUES (10, 'Produto J', 'Descrição do Produto J', 40.0)");
    
    db.run("INSERT OR IGNORE INTO Venda (id, clienteId, produtoId, data_venda, valor_total) VALUES (1, 1, 2, '2023-11-21', '60.00')");
    db.run("INSERT OR IGNORE INTO Venda (id, clienteId, produtoId, data_venda, valor_total) VALUES (2, 3, 5, '2023-11-22', '120.00')");
    db.run("INSERT OR IGNORE INTO Venda (id, clienteId, produtoId, data_venda, valor_total) VALUES (3, 2, 8, '2023-11-23', '180.00')");
